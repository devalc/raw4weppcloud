...
output: 
  cleanrmd::html_document_clean:
    ...
    toc_float: true
params:
  proj_runid: "https://wepp.cloud/weppcloud/runs/lt_202012_26_Bliss_Creek_CurCond/lt-wepp_bd16b69-snow/"
...
get_geometry <- function(runid){
  link <- paste0(params$proj_runid,"browse/export/arcmap/subcatchments.json")
...
totalwatseddf <- data.table::fread(paste0(params$proj_runid,"resources/wepp/totalwatsed.csv"))
